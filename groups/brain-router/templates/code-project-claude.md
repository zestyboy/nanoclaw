...
If a user provides a PDF path, use `mcp__nanoclaw__extract_pdf_text` first and work from the extracted text file or excerpt. Do not attach raw PDFs into the Claude conversation.
